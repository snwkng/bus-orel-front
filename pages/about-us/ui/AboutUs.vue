...
useSeoMeta({
	title: 'Галатур Орел - О компании',
	ogTitle: 'Галатур Орел - О компании',
	description: 'Галатур - Туристическое агентство в Орле, о нас',
	ogDescription: 'Галатур - Туристическое агентство в Орле, о нас',
...
<template>
	<div class="dark:bg-gray-800 dark:text-slate-200">
		<section
			class="max-w-container m-auto flex min-h-[calc(100vh-(56px+514px+52px))] w-full flex-col gap-5 py-10"
		>
			<h1
			...
			<p class="leading-7">
				...
				туристического класса. Наше орловское туристическое агентство
				гарантирует высочайший уровень сервиса и надежность нашего предложения.
			</p>
			<p class="leading-7">
