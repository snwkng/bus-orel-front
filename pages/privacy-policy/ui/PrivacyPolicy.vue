	...
	<div class="dark:bg-gray-800 dark:text-slate-200">
		<section class="max-w-container m-auto flex w-full flex-col gap-5 py-10">
			...
			<p>
				...
				персональных данных, осуществляемые юридическими лицами
				ИП Петлай Г.В. (ИНН 572000036383, ОРГН 304572027400096) (далее по тексту – Оператор).
			</p>
			<p>
				...
				<NuxtLink class="base-link" to="/">https://www.bus-orel.ru</NuxtLink> (далее по тексту – Сайт).
			</p>
			<p>
			...
			<p>
				...
				себе самостоятельно при регистрации (создании учетной записи, при наличии такой возможности) или в
				процессе использования Сервисов (сайта, программ, продуктов), включая
			...
			<p>
				...
				<NuxtLink class="base-link" to="/">https://www.bus-orel.ru</NuxtLink>.
			</p>
			<p>
			...
			<p>
				...
				<NuxtLink class="base-link" to="/">https://www.bus-orel.ru</NuxtLink>(субъекту персональных данных).
			</p>
			<p>
				2.9.
				<strong
				...
				<a class="base-link" href="https://www.1jur.ru/#/document/99/901990046/"
			...
			<p>
				...
				<NuxtLink class="base-link" to="/">https://bus-orel.ru</NuxtLink> (субъект персональных данных).
			</p>
			<p>
			...
			<p>
				...
				интернет-статистики – программных средств «Яндекс.Метрика» и других. Указанные программные средства (сервисы) позволяют
				определить Пользователя Сайта, формировать сведения о его предпочтениях
				и поведения на Сайте Оператора.
			</p>
			<p>
			...
			<p>
				...
				<a class="base-link" href="mailto:avtobus-orel.petlaj@yandex.ru">avtobus-orel.petlaj@yandex.ru</a> с пометкой «Отказ
			...
			<p>
				...
				интернет-статистики (cookie, «Яндекс.Метрика» и др.),
			...
			<p>
				...
				специальные формы, расположенные на сайте <NuxtLink class="base-link" to="/">bus-orel.ru</NuxtLink> или
			...
			<p>
				7.1. Оператор использует метрическую программу - “Яндекс.Метрика” для сбора сведений об использовании Сайта,
				таких как частота посещения Сайта пользователями, посещенные страницы и
				сайты, на которых были пользователи до перехода на данный Сайт. Яндекс.Метрика собирает только IP-адреса, назначенные вам в
				день посещения данного Сайта, но не имя или другие идентификационные
				сведения (обезличенные данные).
			</p>
			<p>
				7.2. Яндекс.Метрика размещает постоянный cookie-файл
				в веб-браузере Пользователя для идентификации его в качестве уникального
				пользователя при следующем вашем посещении Сайта Оператора. Этот
				cookie-файл не может использоваться никем, кроме Яндекс
				соответственно. Сведения, собранные с помощью cookie-файла, будут
				передаваться в Яндекс и храниться на серверах этой корпорации.
			</p>
			<p>
				7.3. Оператор использует сведения, полученные через
				Яндекс.Метрику, только в целях совершенствования услуг на Сайте
				Оператора. Оператор не объединяет сведения, полученные через Яндекс,Метрику, с персональными сведениями Пользователя.
			</p>
			<p>
				7.4. Возможности Яндекс по использованию и передаче третьим
				лицам сведений, собранных средством Яндекс.Метрики о
				посещениях данного Сайта, ограничиваются Политикой конфиденциальности
				Яндекс. Пользователь может запретить
				Яндекс.Метрике узнавать его при повторных посещениях Сайта Оператора,
				отключив cookie-файлы Яндекс.Метрики в своем браузере
				(в настройках браузера) или Пользователь может использовать Блокировщик. 
				Однако это может повлиять на работу некоторых функций
				Сайта. Используя Сайт Оператора, Пользователь соглашается на обработку
				данных о нем Яндекс.Метрикой в порядке и целях,
				указанных выше и по тексту настоящей Политики конфиденциальности.
			</p>
			<p>
				<strong>8. Порядок, условия и сроки обработки персональных данных</strong>
			</p>
			<p>
			...
			<p>
				9.1. Оператор до начала осуществления трансграничной передачи
				персональных
			</p>
			<p>
			...
			<p>
				9.2. Трансграничная передача персональных данных на территории
			...
			<p>
				...
				адресу: <NuxtLink class="base-link" to="/privacy-policy">https://www.bus-orel.ru/privacy-policy</NuxtLink>
			</p>
		</section>
	</div>
</template>
