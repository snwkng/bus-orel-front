...
<template>
	<div
		class="px-base fixed bottom-0 z-10 flex min-h-10 w-full flex-row items-center justify-between border-t dark:border-slate-700 border-slate-400 dark:bg-gray-800 bg-white py-4 text-sm"
	>
		<div class="dark:text-slate-200 text-slate-500">
