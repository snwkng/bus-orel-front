			...
			>
				...
				>
					<router-link :to="{ name: 'home' }">
						<strong class="text-deep-orange">G</strong><span class="h-5 w-auto fill-current text-gray-900">alatour</span>
					</router-link>
					...
					<div class="mt-4">
						...
						>
							<a
								...
								aria-label="vk"
							>
								<i-vk filled :font-controlled="false" class="h-6 w-6" alt="vk" title="vk" />
							</a>
							<a
								href="https://ok.ru/gtorel"
								rel="noopener noreferrer"
								class="ml-3 cursor-pointer text-gray-500 hover:text-gray-700"
								target="_blank"
								aria-label="одноклассники"
							>
								<i-okru filled :font-controlled="false" class="h-6 w-6" alt="одноклассники" title="одноклассники" />
							</a>
						</div>
					</div>
				</div>
				...
				>
					...
					<div class="w-full px-4 md:w-1/2 lg:w-1/4">
						...
						<nav class="mb-10 list-none" aria-label="Support">
							<ul>
								<li class="mt-3">
									<a
										class="cursor-pointer text-gray-500 hover:text-gray-900"
							...
							<ul>
								<li class="mt-3">
									<a
										class="cursor-pointer text-gray-500 hover:text-gray-900"
										target="_blank"
									>Автобусные туры к морю из Орла</a>
								</li>
								<li class="mt-3">
									<a
										class="cursor-pointer text-gray-500 hover:text-gray-900"
										target="_blank"
									>Экскурсионные туры из Орла</a>
								</li>
								<li class="mt-3">
									<a
										class="cursor-pointer text-gray-500 hover:text-gray-900"
										target="_blank"
									>Аренда микроавтобусов</a>
								</li>
								<li class="mt-3">
									<a
										class="cursor-pointer text-gray-500 hover:text-gray-900"
