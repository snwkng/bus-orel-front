...
<template>
	<div class="px-0 py-0 lg:px-20 lg:py-8 dark:bg-gray-800">
		<section
			id="bus-rent"
			class="px-base flex min-h-40 w-full flex-col items-center justify-between gap-4 lg:rounded-xl bg-slate-50 py-8 dark:bg-gray-700 dark:text-white sm:min-h-60 sm:flex-row sm:gap-8 md:gap-16"
		>
			<div
