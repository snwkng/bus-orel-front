...
<template>
	...
	>
		<div
			class="max-w-container flex min-h-10 flex-col items-center justify-between gap-5 md:flex-row"
		>
			...
			<button
				type="button"
				class="rounded-xl bg-secondary-500 px-3 py-1 text-white transition-colors hover:bg-secondary-300"
				@click="cookie = 'true'"
			>
				Подтвердить
			</button>
